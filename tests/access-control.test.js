...
function createDocumentMock() {
  const elements = {
    ...
    "pay-attendance-form-container": createNode("pay-attendance-form-container"),
    "pay-attendance-success-container": createNode("pay-attendance-success-container")
  };
...
test("applyAccessControl locks protected stories when no session exists", () => {
  ...
  assert.equal(doc.elements["pay-attendance-form-container"].hidden, true);
