...
- [ ] T001 Create base web app structure in `src/index.html`, `src/css/styles.css`, `src/js/008-submit-paper-review.js`
...
- [ ] T004 [P] Add JS module scaffolding and init hook in `src/js/008-submit-paper-review.js`
...
- [ ] T006 Define data model helpers for SubmitPaperReviewRequest, SubmitPaperReviewResult, ValidationError in `src/js/008-submit-paper-review.js`
- [ ] T007 Implement LocalStorage adapter for persistence/audit in `src/js/008-submit-paper-review.js`
- [ ] T008 Implement validation utilities for required inputs in `src/js/008-submit-paper-review.js`
- [ ] T009 Implement error rendering utilities (field-level + summary) in `src/js/008-submit-paper-review.js`
...
- [ ] T011 [US1] Build primary UI and inputs for `Submit Paper Review` in `src/index.html`
- [ ] T012 [P] [US1] Add labels, helper text, and required markers in `src/index.html`
- [ ] T013 [US1] Implement primary flow handler (validate, persist, success state) in `src/js/008-submit-paper-review.js`
- [ ] T014 [US1] Implement success state/redirect view in `src/js/008-submit-paper-review.js`
...
- [ ] T016 [US2] Implement validation failure handling and messaging in `src/js/008-submit-paper-review.js`
- [ ] T017 [US2] Block submission when invitation not accepted (error + no state change) in `src/js/008-submit-paper-review.js`
- [ ] T018 [US2] Prevent invalid/partial review data from being stored on failure in `src/js/008-submit-paper-review.js`
- [ ] T019 [US2] Handle database/save failure (service error, no state change, retry) in `src/js/008-submit-paper-review.js`
- [ ] T020 [US2] Implement idempotent handling for rapid double-submit (no duplicates) in `src/js/008-submit-paper-review.js`
- [ ] T021 [US2] Implement retry/reset behavior for failed attempts in `src/js/008-submit-paper-review.js`
