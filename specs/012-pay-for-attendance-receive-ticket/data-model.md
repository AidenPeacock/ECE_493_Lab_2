# Data Model: Pay for Attendance & Receive Ticket

## Entities

### PayForAttendanceReceiveTicketRequest
- **id**: Unique identifier
- **payload**: Submitted inputs for the workflow
- **submitted_at**: Timestamp

### PayForAttendanceReceiveTicketResult
- **id**: Unique identifier
...
- PayForAttendanceReceiveTicketResult is derived from a PayForAttendanceReceiveTicketRequest.
- A PayForAttendanceReceiveTicketResult may include zero or more ValidationError entries.
