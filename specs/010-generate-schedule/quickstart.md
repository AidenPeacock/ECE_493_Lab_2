...
1. Navigate to the generate schedule flow.
...
5. Validate scenario: **Given** set of accepted papers exists., **When** they complete generate schedule, **Then** schedule generated in html and sent to authors of accepted papers.
